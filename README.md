...
| `bot/handlers/unknown.py` | ✅ Redmi-шапка |
| `bot/handlers/youtube_test.py` | ❌ Без шапки |
| `bot/main.py` | ✅ Redmi-шапка |
...
| `dialogue/message_dispatcher.py` | ✅ Redmi-шапка |
...
| `dialogue/state_manager.py` | ✅ Redmi-шапка |
